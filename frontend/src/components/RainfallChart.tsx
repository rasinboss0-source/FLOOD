...
export const RainfallChart: React.FC<RainfallChartProps> = ({
  ...
  const data = [
    ...
    },
    {
      period: '3h Accum',
      value: rainfall3h,
      rate: Math.round((rainfall3h / 3) * 10) / 10,
      isForecast: false,
    },
    {
      period: '6h Accum',
      value: rainfall6h,
      rate: Math.round((rainfall6h / 6) * 10) / 10,
      isForecast: false,
    },
    {
      period: '24h Total',
      value: rainfall24h,
      rate: Math.round((rainfall24h / 24) * 10) / 10,
      isForecast: false,
    },
    {
      period: '3-Day Total',
      value: rainfall3d,
      rate: Math.round((rainfall3d / 72) * 10) / 10,
      isForecast: false,
    },
    {
      period: '+6h Forecast',
      value: forecast6h,
      rate: Math.round((forecast6h / 6) * 10) / 10,
      isForecast: true,
    },
  ];
